...
import { cashOrder } from 'image/OrderActions/OrderActions';
import { z } from 'zod';
...
export default function CheckoutSession() {
  ...
  async function handelCash(values:ShippingFormValues){
    console.log(values);
  ...
  return (
    <div className='w-1/2 mx-auto my-5'>
      <h1 className='text-3xl my-5'>Cash Payment</h1>

      <Form {...shippingForm}>
        <form className='space-y-3' onSubmit={shippingForm.handleSubmit(handelCash)}>
          <FormField
