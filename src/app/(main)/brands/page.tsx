import { Brands } from 'image/types/brands.type';
import { Brand } from 'image/types/brands.type';
...
const brand:Brand[]=data.data  
  ...
  return (
   <>
    <h1 className='text-center text-white text-4xl p-5 btn-color w-full mb-5'>Our Brands</h1>
